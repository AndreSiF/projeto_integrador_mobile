            ...
            child: Form(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 16),
                  CampoForm(label: "Estado de Origem do Fornecedor", value: "", controller: _ufAquiJovController, required: true),
                  CampoForm(label: "Espécie Digitada", value: "", controller: _especieAquiJovController, required: true),
                  CampoForm(label: "Milheiros", value: "", controller: _milheirosAquiJovController, required: true),

                  const Text('Aquisição de ração', style: TextStyle(fontWeight: FontWeight.bold),),
                  const SizedBox(height: 16),
                  CampoForm(label: "Estado de Origem do Fornecedor", value: "", controller: _ufOrigemRacaoController, required: true),
                  CampoForm(label: "Unidades Digitadas", value: "", controller: _unidadesRacaoController, required: true),
                  CampoForm(label: "Quantidade Digitada", value: "", controller: _quantidadeRacaoController, required: true),

                  const Text('Comercialização por espécie', style: TextStyle(fontWeight: FontWeight.bold),),
                  const SizedBox(height: 16),
                  CampoForm(label: "Estado de Origem do Fornecedor", value: "", controller: _ufOrigemComercEspecieController, required: true),
                  CampoForm(label: "Espécie Digitada", value: "", controller: _especieComercialController, required: true),
                  CampoForm(label: "Produção Comercializada (kg)", value: "", controller: _prodComercialController, required: true),
                  CampoForm(label: "Quantidade Digitada", value: "", controller: _quantidadeComercialController, required: true),
                  CampoForm(label: "Preço Médio", value: "", controller: _precoMedioController, required: true),
