...
class PessoaDaos {
  ...
  Future<int> insertProducaoOrnamentais(ProducaoOrnamentais producaoOrnamentais) async {
  ...
  Future<void> atualizarProducaoOrnamentais(ProducaoOrnamentais producaoOrnamentais) async {
    final db = await AppDatabase().database;
    await db.update(
      table,
